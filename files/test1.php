...
<?php
session_start();
include ('/tph/var/www/html/164/serverMonitoring/monitoring/dbconf.php');
include ('/tph/var/www/html/164/serverMonitoring/monitoring/backend_func.php');
...
while(TRUE) {
	...
	//perform checks
	include("/tph/var/www/html/164/serverMonitoring/monitoring/checker.php");	
